<script>
	$(document).ready(function () {
		$("#especeSearch").keyup(function () {
			var nom = $(this).val();
			if (nom.length > 2) {
				var options = "";
				var url = "especeSearch";
				$.getJSON(url, {
					"nom": nom
				}, function (data) {
...
&nbsp;
<a href="traitDisplay?trait_id={$dataTrait.trait_id}"> <img src="display/images/detail.png" height="25">
...
<div class="row">
	<fieldset class="col-md-4">
		...
		<form id="echanChange" method="post" action="echantillonWrite" class="form-horizontal col-md-12">
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					<input id="especeSearch" class="form-control" placeholder="Espèce à rechercher" autocomplete="off"
						{if $dataEchan.ech_id==0}autofocus{/if}> <select id="espece_id" name="espece_id"
						class="form-control">
			...
			<div class="form-group">
				...
				<div class="col-md-8">
					<input class="nombre form-control" id="nt" name="nt" value="{$dataEchan.nt}" autocomplete="off"
						required>
				</div>
			</div>
			<div class="form-group">
	...
	<fieldset class="col-md-8">
		<legend>Poissons mesurés{if strlen($dataEchan.lt_max) > 0} (Taille max :
			<span id="lt_max">{$dataEchan.lt_max* 10}</span> mm){/if}
		</legend>
		<div class="row">
			<div class="col-md-12">
